...
vnBERT trains on an **AnnData** (`.h5ad`) sparse matrix where rows are samples and columns are token IDs. The `vnBertTokenizerTabular` tokenizer converts your raw tabular data into this format.
